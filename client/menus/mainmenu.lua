--[[
    ...
    🐺 LXR Mailbox System - Main Menu (Client)

    Builds and manages all FeatherMenu pages: registration, mail actions, compose,
    inbox, message view, contacts management, and contact search.
